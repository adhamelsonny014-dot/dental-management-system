...
const VALUES = [
  {
    title: "Patient-first",
    text: "Every decision starts with your comfort, clarity, and long-term oral health.",
  },
  {
    title: "Evidence-based",
    text: "We use modern diagnostics and proven techniques — never unnecessary treatment.",
  },
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-12 items-start">
        <section>
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            SmileCare began with a simple belief: dental visits should feel calm, not stressful. Today our
            team of dentists, hygienists, and care coordinators work together under one digital system so your
            records, charts, and treatment history are always at hand.
          </p>
          <p className="text-slate-600 leading-relaxed">
            Whether you need a routine cleaning or a full treatment plan, you will always know what to expect
            — and why we recommend each step.
          </p>
        </section>
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <section className="mt-12 grid md:grid-cols-3 gap-6">
          {VALUES.map((v) => (
            <article
              key={v.title}
              className="bg-white border border-clinic-border rounded-2xl p-6 text-center"
            >
    ...
    <section className="py-16 text-center">
      <section className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <p className="flex flex-wrap justify-center gap-4">
          <Link
            to="/doctors"
            className="bg-clinic-ink text-clinic-cream px-6 py-3 rounded-full text-sm font-medium hover:bg-clinic-accent transition-colors"
          >
            Meet our doctors
          </Link>
          <Link
            to="/book"
            className="border border-clinic-border px-6 py-3 rounded-full text-sm font-medium hover:border-clinic-accent transition-colors"
          >
            Book a visit
          </Link>
        </p>
