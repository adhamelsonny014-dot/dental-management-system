...
const NAV = [
  ...
  },
  {
    ...
    items: [
     ...
     { to: "/booking-requests", label: "Web bookings", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", roles: ["admin", "receptionist", "dentist"] },
      { to: "/staff", label: "Staff", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z", roles: ["admin"] },
  ...
  },
  {
    group: "Clinical",
    items: [
      { to: "/patients", label: "Dental Charts", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
    ],
  },
  {
    group: "Analytics",
    items: [
      { to: "/reports", label: "Reports", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", roles: ["admin", "receptionist"] },
    ],
  },
  {
    group: "System",
    items: [
      ...
      { to: "/doctor-accounts", label: "Login Accounts", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z", roles: ["admin"] },
    ],
  },
];
      ...
      <footer className="px-3 py-4 border-t border-white/10">
        <section className="flex items-center gap-3 px-3 py-2 mb-1">
          ...
          <section className="min-w-0">
            ...
            <span className={`text-xs px-1.5 py-0.5 rounded font-medium ${roleColor[user?.role] || "bg-slate-700 text-slate-300"}`}>
              {user?.role}
            </span>
          </section>
        </section>
